...
- 已将前端主流程、按钮、结果页、空状态、加载态和页脚改为中文展示。
- 已将页面品牌改为“书灵 BookSage：智能图书推荐系统”。
- 已补充推荐方式中文映射，结果页会展示当前推荐方式说明和推荐强度。
- 已将 FastAPI 标题、描述和健康检查响应补充为中文项目标识。
- 已将 README 改写为中文提交版，并新增 `PROJECT_REPORT.md` 作为项目报告。
- 保持原有推荐接口和方法参数兼容，不改底层模型与训练流程。
